...
// v2		fingerprint deviceId: "0x3101", inClusters: "0x70,0x32,0x60,0x85,0x56,0x72,0x86"
    ...
    // Amps row
        ...
        valueTile("ampsTwo", "device.ampsTwo", decuration: "flat") {
        	state "default", label:'${currentValue}'       		
        }
    ...
    // Controls row
		...
		graphTile(name: "powerGraph", attribute: "device.powerDisp")
...
// HEM Version Configuration only needs to be done here - comments to choose what gets displayed
		...
		details([
			"powerGraph","energyOne","energyDisp","energyTwo",
